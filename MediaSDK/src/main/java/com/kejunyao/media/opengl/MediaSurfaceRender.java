 ...
 * @since 2020年06月19日
 */
class MediaSurfaceRender implements GLSurfaceView.Renderer {
    ...
    MediaSurfaceRender(Context context) {
    ...
    private void initRenderYUV() {
        ...
        String fragmentSource = RenderShaderUtils.readRaw(context, R.raw.fragment_shader);
